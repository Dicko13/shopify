...
<p>
<a href="{{  route('produits.index') }}" class="btn bg-danger shadow-lg btn-round text-light btn-lg btn-rised">Consulter nos produits</a>
</p>					
        </div>
      </div>
    </div>
       ...
       {{-- <div class="col-md-12"> --}}
            @foreach ($produits as $produit)
               <div class="col-md-4">
                ...
                <img width="100" class="card-img-top" src="{{ $produit->image 
